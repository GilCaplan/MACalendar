...
for _k, _v in (("MACALENDAR_DB", "/tmp/adv.db"), ("MACALENDAR_MEMORY_DB", "/tmp/adv_m.db"),
               ("MACALENDAR_VOCAB", "/tmp/adv_v.json"),
               ("MACALENDAR_CATEGORIES", "/tmp/adv_c.json"),
               ("MACALENDAR_TRACE_BUS", "/tmp/adv_bus.jsonl"),
