...
# The kind vocabulary and its two readers moved to `fastseg/kind.py`
# (2026-09-20): the live tagger had been importing them from THIS retired
# module. Imported back here so the `old_seg` switch and its tests still
# work, and so there is one copy rather than two.
from assistant.engine.segmentation.fastseg.kind import (  # noqa: E402,F401
    _CALENDAR_DEST_RE, _CHORE_VERB, _CLOCKISH_RE, _DATED_RE, _GATHERING_RE, _LIST_DEST, _LOOK_VERB, _NEED_ENCOUNTER_RE, _OCCASION_RE, _REMINDISH_RE, _REMIND_TO_VERB_RE, _REVIEW_RE, _TASK_RE, _TODO_DONE, _TODO_NAMED, _enforce_pinned_kinds, _kind_of)
