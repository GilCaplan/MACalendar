...
<!-- code-stats: {"total_files": 604, "total_lines": 169073} -->
**Generated — do not edit by hand.** The pre-commit hook (`python -m scripts.code_stats --install-hook`) rewrites this whenever the numbers move, so it describes the commit it ships in. By hand: `python -m scripts.code_stats --write`; `--check` says whether it is current, and `tests/unit/test_code_size.py` fails once it is more than 2% out.

**169,073 lines of source across 604 files.** Of that, **94,116 lines are the live product** — the rest is tests, the retired brain, the measurement boards and the dataset tooling.
...
| Engine (the brain, shipped path) | 53 | 19,056 |
...
- **Prose** — markdown and the published HTML explainers: 48,305 lines across 117 files.
