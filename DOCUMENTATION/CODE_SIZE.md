...
<!-- code-stats: {"total_files": 615, "total_lines": 173043} -->
**Generated — do not edit by hand.** The pre-commit hook (`python -m scripts.code_stats --install-hook`) rewrites this whenever the numbers move, so it describes the commit it ships in. By hand: `python -m scripts.code_stats --write`; `--check` says whether it is current, and `tests/unit/test_code_size.py` fails once it is more than 2% out.

**173,043 lines of source across 615 files.** Of that, **95,371 lines are the live product** — the rest is tests, the retired brain, the measurement boards and the dataset tooling.

| category | files | lines |
|---|---:|---:|
| Test code | 187 | 37,101 |
...
| Engine (the brain, shipped path) | 55 | 19,594 |
...
- **Prose** — markdown and the published HTML explainers: 48,859 lines across 119 files.
