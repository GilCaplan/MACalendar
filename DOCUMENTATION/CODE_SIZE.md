...
<!-- code-stats: {"total_files": 566, "total_lines": 157158} -->
**Generated — do not edit by hand.** The pre-commit hook (`python -m scripts.code_stats --install-hook`) rewrites this whenever the numbers move, so it describes the commit it ships in. By hand: `python -m scripts.code_stats --write`; `--check` says whether it is current, and `tests/unit/test_code_size.py` fails once it is more than 2% out.

**157,158 lines of source across 566 files.** Of that, **86,887 lines are the live product** — the rest is tests, the retired brain, the measurement boards and the dataset tooling.

| category | files | lines |
|---|---:|---:|
| Test code | 164 | 33,110 |
| iOS application | 60 | 20,777 |
| Mac application (calendar GUI) | 33 | 18,306 |
| Engine (the brain, shipped path) | 50 | 17,750 |
...
- **Prose** — markdown and the published HTML explainers: 46,266 lines across 114 files.
