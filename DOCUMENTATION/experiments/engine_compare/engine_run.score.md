# Dataset run score — `/var/folders/0f/nk3dnvrd54jbjz_qn40_ynwh0000gn/T/engine_compare_6gkg6vkk/engine_run.db`

- product-adjusted count-correct **87%** (3 overridden rows; raw below is the comparable number)
- **100 prompts** scored · count-correct **85%** · garbage-title rate **0%**
- total_ms p50 57 · p95 44783
...
- count-correct rate: 70% → 85%
- **4 got worse**, **20 got better**, 65 still pass, 11 still fail
