# Dataset run score — `/var/folders/0f/nk3dnvrd54jbjz_qn40_ynwh0000gn/T/engine_compare_d0q5gzxl/engine_run.db`

- product-adjusted count-correct **82%** (3 overridden rows; raw below is the comparable number)
- **100 prompts** scored · count-correct **80%** · garbage-title rate **15%**
- total_ms p50 56 · p95 46562
...
| event+task | 11 | 36% | 27% | 18% |

## event+task: which half goes missing when it fails

- both present: 4 · event missing: 3 · task missing: 3 · both missing: 1
...
- **3 got worse**, **14 got better**, 66 still pass, 17 still fail
